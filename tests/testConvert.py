...
class TestConvert(unittest.TestCase):
    ...
    def test_get_keyword(self):
        self.assertEqual("convert", convert.get_keyword())

    def test_helping(self):
        self.assertEqual("|convert <Numeral system'to'Numeral system> <number> - Converts numbers between two numeral systems", convert.helping())
    ...
    def test_use_wrong_number_system(self):
        ...
        self.assertEqual(("Conversion Error. Please make shure your bases aren't bigger than 36 and that your input matches the base", False), convert.use(message))
    ...
    def test_use_success(self):
        ...
        self.assertEqual(("10100", False), convert.use(message))
